...
| product_area_count | Independent | The number of product areas within ABC Grocery the customer has shopped in - 3 months pre campaign |
...
The variables that have been dropped are *total_items* and *credit_score* - we will continue on with the remaining six!
